...
-(void)setupNavBar {
    ...
    UIBarButtonItem *setItem = [UIBarButtonItem itemWithImageName:@"mine-setting-icon" itemWithHighlightedImageName:@"mine-setting-icon-click" addTarget:nil action:nil];
